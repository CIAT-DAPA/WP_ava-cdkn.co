...
<?php
	...
	<script type='text/javascript'>
		var smcf_messages = {
			loading: '" . addslashes(__("Cargando...", "smcf")) . "',
			sending: '" . addslashes(__("Enviando...", "smcf")) . "',
			thankyou: '" . addslashes(__("Gracias!", "smcf")) . "',
			error: '" . addslashes(__("Uh oh...", "smcf")) . "',
			goodbye: '" . addslashes(__("Hasta pronto...", "smcf")) . "',
			name: '" . addslashes(__("Nombre", "smcf")) . "',
			email: '" . addslashes(__("Correo", "smcf")) . "',
			emailinvalid: '" . addslashes(__("La direccion de correo es invalida.", "smcf")) . "',
			message: '" . addslashes(__("Mensaje", "smcf")) . "',
			and: '" . addslashes(__("y", "smcf")) . "',
			is: '" . addslashes(__("es", "smcf")) . "',
			are: '" . addslashes(__("son", "smcf")) . "',
			required: '" . addslashes(__("requerido(s).", "smcf")) . "'
		}
	</script>";
	...
	<div class='smcf-content'>
		...
		<form action='" . $url["path"] . "/smcf_data.php' style='display:none'>
			...
			<label for='smcf-email'>*" . __("Correo", "smcf") . ":</label>
		...
		$output .= "<label for='smcf-message'>*" . __("Mensaje", "smcf") . ":</label>
		...
		$output .= "<label>&nbsp;</label>
			<button type='submit' class='smcf-button smcf-send' tabindex='1006'>" . __("Enviar", "smcf") . "</button>
			<button type='submit' class='smcf-button smcf-cancel simplemodal-close' tabindex='1007'>" . __("Cancelar", "smcf") . "</button>
