...
DOCUMENTATION at: http://www.yourinspirationweb.com/tf/beauty-clean/documentation/index.html
...
Download the Documentation here: http://www.yourinspirationweb.com/tf/beauty-clean/documentation-beauty-free.zip
...
2. Upload your logo
To change the logo, you must go on Appearance >>Theme Options >> General tab. Here you can choose or add a url of your logo (image) or to use title and description, like our demo. Title will be displayed with a calligraphic font (the same used for “Beauty&Clean” in our demo) and description with the “Champagne&Limousine” font.

In this page you can:
1- Set the date format
2- Add additional CSS rules
